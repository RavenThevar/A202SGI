...
public class serviceastro extends AppCompatActivity
{
    Button sHome, sPay;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_serviceastro);
        ...
        sHome.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(serviceastro.this, Services.class);
        ...
        sPay.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                payment.setType("Astro");

                reff.push().setValue(payment);
                Toast.makeText(serviceastro.this, "Payment of RM " + amount + " to Astro is successful.!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(serviceastro.this, Services.class);
                intent.putExtra("email", email);
                startActivity(intent);
            }
