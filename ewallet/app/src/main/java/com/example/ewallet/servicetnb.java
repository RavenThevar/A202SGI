...
public class servicetnb extends AppCompatActivity
{
    Button sHome, sPay;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_servicetnb);
        ...
        sHome.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(servicetnb.this, Services.class);
        ...
        sPay.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Toast.makeText(servicetnb.this, "Payment of RM " + amount + " to TNB is successful.!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(servicetnb.this, Services.class);
                intent.putExtra("email", email);
                startActivity(intent);
            }
